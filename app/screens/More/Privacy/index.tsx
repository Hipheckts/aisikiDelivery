      ...
      <KeyboardAvoidingView
        ...
        keyboardVerticalOffset={Platform.OS === 'ios' ? 40 : 0}>
            <View style={styles.container}>
                ...
                <Text style={styles.text}>SmartAgro Technologies Limited, a company incorporated under the laws of the Federal Republic of Nigeria, having its office at No 23, Akpapava Road, Benin City, Nigeria. As a part of its objectives, created a mobile application and website that facilitates it users registered on the Aisiki Platform, to buy fresh farm produce across cities in Nigeria.</Text>
